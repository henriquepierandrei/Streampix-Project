...
public class WebhookService {
    ...
    public void updateDonationStatus(String id, String statusDetail){
        ...
        LogStatusDonationEnum status = null;
        ...
        if (statusDetail.equals("pending_waiting_transfer")) status = LogStatusDonationEnum.PENDING_PAYMENT;
        if (statusDetail.equals("accredited")) status = LogStatusDonationEnum.SUCCESSFUL_PAYMENT;
        ...
        if (log.getStatusDonation().equals(LogStatusDonationEnum.UNSUCCESSFUL_PAYMENT)) webSocketController.notifyDonationSuccess(log.getTransactionId(), log.getStreamerId(), false, log.getAudioUrl(),  response);
    }
