...
public class DonationController {
     ...
     */
    @PostMapping
    public ResponseEntity<?> donation(@RequestBody DonationFullRequestDto dto , @RequestParam(name = "nickname") String nickname) throws Exception {
        var response = this.donationService.donationService(dto, nickname);
